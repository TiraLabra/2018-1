...
* **Keskiviikkona 17.10. klo 10:15-12:00** Exactumin salissa **C123** (_tiedossa myöhemmin_)
...
* **Ohjelma:**
    * Suoritettava ohjelma (esim. jar-tiedosto)
        * jos käytät mavenia, niin ohjeita suoritettavan jar-tiedoston tekemiseen esim. [kesän javalabran sivuilla](https://github.com/javaLabra/Javalabra2017-6/blob/master/ohjeet/Deadline-6.md)
